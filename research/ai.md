...
7. Do not use single-letter variables like `u` for URLs; use descriptive one- or two-word names instead. Do not alter other standard or conventional variable names unless they share this exact issue.
