...
//
// The code_challenge is the package-internal value generated by Step1GetChallenge.
func Step3GetAuthCode(postAuthEndpoint string) (string, error) {
   fullURL := "https://oauth.unext.jp" + postAuthEndpoint

   form := url.Values{}
   form.Set("code_challenge", pkceChallenge)
